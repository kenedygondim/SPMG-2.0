...
public interface PessoaReactiveCrudRepository extends ReactiveCrudRepository<Pessoa, String> {
    @Query("INSERT INTO tb_pessoas (nome_completo, cpf, rg, sexo, numero_telefone, dt_nascimento, endereco_id) VALUES (:nome, :cpf, :rg, :sexo, :telefone, :dataNascimento, :enderecoId)")
